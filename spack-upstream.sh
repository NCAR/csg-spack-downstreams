...
print_usage () {
    ...
    echo "            --prefix=<install-path>    : specify spack installation location. Default: /glade/work/$USER/spack_<version>"
...
log "git clone https://github.com/NCAR/csg-spack-fork $INSTALL_DIR"
git clone https://github.com/NCAR/csg-spack-fork $INSTALL_DIR
